...
class LoadStreams:
    ...
    def __init__(self, sources='streams.txt', img_size=640, stride=32, auto=True):
        ...
        for i, s in enumerate(sources):  # index, source
            ...
            cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 640) #change width here
            ...
            left_right=np.split(self.imgs[i],2,axis=1)
            self.imgs[i]=left_right[0] #right
    ...
    def update(self, i, cap, stream):
        ...
        while cap.isOpened() and n < f:
            ...
            if n % read == 0:
                ...
                if success:
                    left_right=np.split(im,2,axis=1)
                    im=left_right[0] #right
                    self.imgs[i] = im
                else:
